...
export default async function RootLayout({
  ...
  return (
    <html lang={lang}>
      ...
      <body
        className={`${plusJakartaSans.variable} ${monoFont.variable} font-sans bg-[#F8FAFC] text-slate-900 antialiased min-h-screen selection:bg-blue-100 selection:text-blue-900`}
      >
        {children}
      </body>
    </html>
